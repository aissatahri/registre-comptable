...
#define SourceJar "..\\target\\registre-comptable-1.2.0.jar"
...
OutputBaseFilename=RegistreComptable-1.1.0-setup
OutputDir=Output
Compression=lzma
...
Source: "launcher-1.1.0.exe"; DestDir: "{app}"; Flags: ignoreversion
#endif
...
#if HAS_NATIVE_LAUNCHER
Name: "{group}\Registre Comptable"; Filename: "{app}\launcher-1.1.0.exe"; WorkingDir: "{app}"; IconFilename: "{app}\app.ico"
Name: "{commondesktop}\Registre Comptable"; Filename: "{app}\launcher-1.1.0.exe"; WorkingDir: "{app}"; IconFilename: "{app}\app.ico"; Tasks: desktopicon
#else
...
#if HAS_NATIVE_LAUNCHER
Filename: "{app}\launcher-1.1.0.exe"; WorkingDir: "{app}"; Flags: nowait postinstall skipifsilent shellexec
#else
